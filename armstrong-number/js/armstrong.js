...
function start(){
    ...
    inputButton1.style.backgroundColor="tan";
...
function run(){
 ...
 if(s==number)
{
	document.write("The given number"+" " +num1 +" "+"is armstrong number");	
}
else
{
	document.write("The given number"+" " +num1 +" "+"is not armstrong number");	
}
 //output.innerHTML=s;
}
